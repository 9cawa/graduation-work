...
public class SmsFrequencyFilter implements ChainFilter {
    ...
    public boolean filter(Message<?> message) {
        ...
        Optional<Notification> lastNotification = notificationRepository.findFirstByRecipient_IdAndNoticeAndChannelOrderByTimestampDesc(recipient.getId(), notice, Channel.SMS);
